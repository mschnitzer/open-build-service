class Webui::ProjectController < Webui::WebuiController
  ...
  def new
    ...
    @show_restore_message = true if params[:restore_option] && Project.deleted?(params[:name])
  end
  ...
  def create
    ...
    if Project.deleted?(params[:project][:name])
      unless params[:restore_option_provided]
  ...
  def restore
    ...
    if Project.deleted?(params[:project])
      project = Project.restore(params[:project])
